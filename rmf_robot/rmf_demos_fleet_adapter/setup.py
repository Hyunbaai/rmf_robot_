...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'fleet_robot=rmf_demos_fleet_adapter.fleet_robot:main',
            'test_path_request=rmf_demos_fleet_adapter.test_path_request:main',
            'test_robot_state=rmf_demos_fleet_adapter.test_robot_state:main',
            'fleet_manager_with_fsm=rmf_demos_fleet_adapter.fleet_manager_with_fsm:main',
        ],
    },
)
