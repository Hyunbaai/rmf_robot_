...
def generate_launch_description():
    ...
    robots = [
        {'name': 'robot_1', 'x_pose': 2.0, 'y_pose': -2.5, 'z_pose': 0.30,
                           'roll': 0.0, 'pitch': 0.0, 'yaw': 0.0},
        # {'name': 'robot_2', 'x_pose': 10.0, 'y_pose': -2.5, 'z_pose': 0.30,
        #                    'roll': 0.0, 'pitch': 0.0, 'yaw': 0.0}
        ]
    ...
    declare_robot1_params_file_cmd = DeclareLaunchArgument(
        'robot_1_params_file',
        default_value=os.path.join(gps_wpf_dir, 'config', 'nav2_robot_1_params.yaml'),
        description='Full path to the ROS2 parameters file to use for robot1 launched nodes')

    declare_robot2_params_file_cmd = DeclareLaunchArgument(
        'robot_2_params_file',
        default_value=os.path.join(gps_wpf_dir, 'config', 'nav2_robot_2_params.yaml'),
    ...
    for robot in robots:
        ...
        group = GroupAction([
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(os.path.join(gps_launch_dir,
                                                           'single_gps_waypoint_follower.launch.py')),
